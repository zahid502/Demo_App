...
import {ColorTheme, IconTheme, Theme} from '@app-interfaces';
...
const ThemeContext = React.createContext<ProvidedValue>({
  Icons: DEFAULT_LIGHT_THEME.icon,
  colors: DEFAULT_LIGHT_THEME.color,
  theme: DEFAULT_LIGHT_THEME,
  isLightTheme: true,
  toggleTheme: () => {
    Logger.log('ThemeProvider is not rendered!');
  },
});
...
export const ThemeProvider = React.memo<Props>(props => {
  ...
  const MemoizedValue = React.useMemo(() => {
    const value: ProvidedValue = {
      ...
      colors: theme.color,
      theme,
      isLightTheme: theme.id === DEFAULT_LIGHT_THEME_ID,
