...
```
cd existing_repo
git remote add origin https://gitlab.com/thryiv/gepcash/frontend/cross-platform.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/thryiv/gepcash/frontend/cross-platform/-/settings/integrations)
